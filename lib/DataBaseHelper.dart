import 'dart:io';
import 'package:Progi\FlutterMySql\lib\data\model/role.dart';
import 'package:Progi\FlutterMySql\lib\data\model/post.dart';
...
class DataBaseHelper {
  ...
  Future<void> init() async {
    ...
    _pathDB = join(_appDocumentDirectory!.path, 'Jysk.db');
 ...
 Future<void> onInitTable(Database db) async {
    try {
      db.insert(DataBaseRequest.tablePost, Post(id:1,name_post: 'Бухгалтер').toMap());
      db.insert(DataBaseRequest.tablePost, Post(id:2,name_post: 'Администратор').toMap());
